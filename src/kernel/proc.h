...
struct proc {
  ...
  char p_group;       /* process group (0 if A, 1 if B) */
};
...
#define MAX_A		5	/* max processes in group A */
#define MAX_B		3	/* max processes in group B */
...
EXTERN int CUR_A;	/* number of processes currently in group A */
EXTERN int CUR_B;	/* number of processes currently in group B */
